...
<div align="center">
<table>
	<span><font color="orange" size="6"><b><u> Storage Files:</u></b></font></span>
	<tr><td><br></td></tr>
	<tr>
	...
	<th>&nbsp;&nbsp;</th>
	<th><font color="#996600" size="5"><b><u>Request</u></b></font></th>
	</tr>
<%
...
<td><font color="#669999" size="4"><b><%=rs.getString("fid")%></b></font></td>
	...
	<td>&nbsp;&nbsp;</td>
<td><a href="dataverification1.jsp?fid=<%=rs.getString("fid")%>&fname=<%=rs.getString("fname")%>&groupname=<%=rs.getString("groupname")%>"><font color="green" size="3"><b>Request to TPA</b></font></a></td>
</tr>
<%
}
%>
