			...
			<div class="container">
				...
				<div class="top-menu">
					<span class="menu"><img src="images/menu.png" alt=""/>  </span>
						<ul>
							<li><a href="tpahome.jsp" class="active">home</a></li>
								<li><a href="auditchallenge.jsp" >Auditing Challenges</a></li>
									<li><a href="contact.jsp" target="_blank">Contact</a></li>
										<li><a href="index.html">Logout</a></li>
										
												<%
												String tpa = session.getAttribute("tpa").toString();
												%>
										<br><br><br><br><br><br><font color="yellow" size="3">Welcome <%=tpa%></font>
												 <!-- script for menu -->
							<script>
